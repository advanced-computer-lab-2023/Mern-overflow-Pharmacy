                    ...
                    >
                      {statuses.map((value) => (
                        <MenuItem key={value} value={value}>{`${value
                          .charAt(0)
                          .toUpperCase()}${value.slice(1)}`}</MenuItem>
                      ))}
                    </Select>
                  </FormControl>
                </Container>
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell key="hourlyRate" sx={{ fontWeight: "bold" }}>
                    Rate
                  </TableCell>
                  <TableCell key="affiliation" sx={{ fontWeight: "bold" }}>
                    Affiliation
                  </TableCell>
                  <TableCell key="education" sx={{ fontWeight: "bold" }}>
                    Education
                  </TableCell>
                  <TableCell key="files" sx={{ fontWeight: "bold" }}>
                    Documents
                  </TableCell>
                      ...
                      <TableRow key={row.username}>
                        ...
                        >
                          ...
                          {row.status === "rejected" ? (
                            <>
                              <CancelIcon
                                style={{ color: "#d33c5c", marginRight: "8px" }}
                              />{" "}
                              Rejected{" "}
                            </>
                          ) : null}
                          {row.status === "accepted" ? (
                            <>
                              <CheckCircleIcon
                                style={{ color: "#22bb33", marginRight: "8px" }}
                              />{" "}
                              Accepted{" "}
                            </>
                          ) : null}
